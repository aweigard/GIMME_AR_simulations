...
# GIMME-AR and GIMME-MS model fits in the balanced (BA) condition. It
...
# 2 individuals (<.01%) did not converge
length(ar.recovery.sum[is.na(ar.recovery.sum$badPsi),]$badPsi)
# [1] 2
2/75000*100
#[1] 0.002666667

# 6567 individual models (8.8%) were implausible
...
# 1 individual had no model that converged
...
# 4390 individuals had no plausible model
...
#that took a long time, so save this
save.image("balanced_recovery.RData")
