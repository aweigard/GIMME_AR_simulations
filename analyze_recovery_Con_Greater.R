...
# GIMME-AR and GIMME-MS model fits in the con. greater (CG) condition. It
...
# 242 individuals (~.33%) did not converge
length(ar.recovery.sum[is.na(ar.recovery.sum$badPsi),]$badPsi)
# [1] 252
252/75000*100
#[1] 0.01866667

# 11826 individual models (15.8%) were implausible
...
# 66 individuals had no model that converged
...
# 9801 individuals had no plausible model
...
# save it
save.image("con_greater_recovery.RData")
